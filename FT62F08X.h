...
// Register: TKTMR
volatile unsigned char           TKTMR                  @ 0x38C;
// bit and bitfield definitions

// Register: TKC0
volatile unsigned char           TKC0                   @ 0x38D;
// bit and bitfield definitions
volatile bit TDMY0               @ ((unsigned)&TKC0*8)+0;
volatile bit TDMY1               @ ((unsigned)&TKC0*8)+1;
volatile bit TDMY2               @ ((unsigned)&TKC0*8)+2;
volatile bit TKCFOV              @ ((unsigned)&TKC0*8)+4;
volatile bit TKST                @ ((unsigned)&TKC0*8)+5;
volatile bit TKRCOV              @ ((unsigned)&TKC0*8)+6;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	TDMY0             : 1;
...
// Register: TKC1
volatile unsigned char           TKC1                   @ 0x38E;
// bit and bitfield definitions
volatile bit OPTION0             @ ((unsigned)&TKC1*8)+0;
volatile bit OPTION1             @ ((unsigned)&TKC1*8)+1;
volatile bit TDMY3               @ ((unsigned)&TKC1*8)+2;
volatile bit SEG0                @ ((unsigned)&TKC1*8)+5;
volatile bit SEG1                @ ((unsigned)&TKC1*8)+6;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	OPTION0           : 1;
...
// Register: WPROOF1
volatile unsigned char           WPROOF1                  @ 0x38F;
// bit and bitfield definitions

// Register: WPROOF2
volatile unsigned char           WPROOF2                  @ 0x390;
// bit and bitfield definitions

// Register: WPROOF3
volatile unsigned char           WPROOF3                  @ 0x391;
// bit and bitfield definitions
#ifndef _LIB_BUILD
volatile union {
    struct {
...
// Register: M0ANALOG
volatile unsigned char           M0ANALOG                 @ 0x392;
// bit and bitfield definitions
volatile bit M0RSET0              @ ((unsigned)&M0ANALOG*8)+0;
volatile bit M0RSET1              @ ((unsigned)&M0ANALOG*8)+1;
volatile bit M0FILCS0             @ ((unsigned)&M0ANALOG*8)+2;
volatile bit M0FILCS1             @ ((unsigned)&M0ANALOG*8)+3;
volatile bit M0FILCS2             @ ((unsigned)&M0ANALOG*8)+4;
volatile bit M0VIHVIL0            @ ((unsigned)&M0ANALOG*8)+5;
volatile bit M0VIHVIL1            @ ((unsigned)&M0ANALOG*8)+6;
volatile bit M0VIHVIL2            @ ((unsigned)&M0ANALOG*8)+7;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	M0RSET0           : 1;
        ...
        unsigned	M0FILCS1          : 1;
        unsigned	M0FILCS2          : 1;
        unsigned	M0VIHVIL0         : 1;
        unsigned	M0VIHVIL1         : 1;
        unsigned	M0VIHVIL2         : 1;
    };
    struct {
        unsigned	M0RSET            : 2;
        unsigned	M0FILCS           : 3;
...
// Register: M1ANALOG
volatile unsigned char           M1ANALOG                 @ 0x393;
// bit and bitfield definitions
volatile bit M1RSET0              @ ((unsigned)&M1ANALOG*8)+0;
volatile bit M1RSET1              @ ((unsigned)&M1ANALOG*8)+1;
volatile bit M1FILCS0             @ ((unsigned)&M1ANALOG*8)+2;
volatile bit M1FILCS1             @ ((unsigned)&M1ANALOG*8)+3;
volatile bit M1FILCS2             @ ((unsigned)&M1ANALOG*8)+4;
volatile bit M1VIHVIL0            @ ((unsigned)&M1ANALOG*8)+5;
volatile bit M1VIHVIL1            @ ((unsigned)&M1ANALOG*8)+6;
volatile bit M1VIHVIL2            @ ((unsigned)&M1ANALOG*8)+7;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	M1RSET0           : 1;
        ...
        unsigned	M1FILCS1          : 1;
        unsigned	M1FILCS2          : 1;
        unsigned	M1VIHVIL0         : 1;
        unsigned	M1VIHVIL1         : 1;
        unsigned	M1VIHVIL2         : 1;
    };
    struct {
        unsigned	M1RSET            : 2;
        unsigned	M1FILCS           : 3;
...
// Register: M2ANALOG
volatile unsigned char           M2ANALOG                 @ 0x394;
// bit and bitfield definitions
volatile bit M2RSET0              @ ((unsigned)&M2ANALOG*8)+0;
volatile bit M2RSET1              @ ((unsigned)&M2ANALOG*8)+1;
volatile bit M2FILCS0             @ ((unsigned)&M2ANALOG*8)+2;
volatile bit M2FILCS1             @ ((unsigned)&M2ANALOG*8)+3;
volatile bit M2FILCS2             @ ((unsigned)&M2ANALOG*8)+4;
volatile bit M2VIHVIL0            @ ((unsigned)&M2ANALOG*8)+5;
volatile bit M2VIHVIL1            @ ((unsigned)&M2ANALOG*8)+6;
volatile bit M2VIHVIL2            @ ((unsigned)&M2ANALOG*8)+7;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	M2RSET0           : 1;
        ...
        unsigned	M2FILCS1          : 1;
        unsigned	M2FILCS2          : 1;
        unsigned	M2VIHVIL0         : 1;
        unsigned	M2VIHVIL1         : 1;
        unsigned	M2VIHVIL2         : 1;
    };
    struct {
        unsigned	M2RSET            : 2;
        unsigned	M2FILCS           : 3;
...
#endif
// Register: M3ANALOG
volatile unsigned char           M3ANALOG                 @ 0x395;
// bit and bitfield definitions
volatile bit M3RSET0              @ ((unsigned)&M3ANALOG*8)+0;
volatile bit M3RSET1              @ ((unsigned)&M3ANALOG*8)+1;
volatile bit M3FILCS0             @ ((unsigned)&M3ANALOG*8)+2;
volatile bit M3FILCS1             @ ((unsigned)&M3ANALOG*8)+3;
volatile bit M3FILCS2             @ ((unsigned)&M3ANALOG*8)+4;
volatile bit M3VIHVIL0            @ ((unsigned)&M3ANALOG*8)+5;
volatile bit M3VIHVIL1            @ ((unsigned)&M3ANALOG*8)+6;
volatile bit M3VIHVIL2            @ ((unsigned)&M3ANALOG*8)+7;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	M3RSET0           : 1;
        ...
        unsigned	M3FILCS1          : 1;
        unsigned	M3FILCS2          : 1;
        unsigned	M3VIHVIL0         : 1;
        unsigned	M3VIHVIL1         : 1;
        unsigned	M3VIHVIL2         : 1;
    };
    struct {
        unsigned	M3RSET            : 2;
        unsigned	M3FILCS           : 3;
...
volatile unsigned char           TKM0C0               @ 0x396;
// bit and bitfield definitions
volatile bit M0SOF0               @ ((unsigned)&TKM0C0*8)+0;
volatile bit M0SOF1               @ ((unsigned)&TKM0C0*8)+1;
volatile bit M0SOFC               @ ((unsigned)&TKM0C0*8)+3;
volatile bit M0FILE               @ ((unsigned)&TKM0C0*8)+4;
volatile bit M0DFEN               @ ((unsigned)&TKM0C0*8)+5;
volatile bit M0MXS0               @ ((unsigned)&TKM0C0*8)+6;
volatile bit M0MXS1               @ ((unsigned)&TKM0C0*8)+7;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	M0SOF0              : 1;
...
// Register: TKM0C1
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           TKM0C1               @ 0x397;
// bit and bitfield definitions
volatile bit M0K1IO               @ ((unsigned)&TKM0C1*8)+0;
volatile bit M0K2IO               @ ((unsigned)&TKM0C1*8)+1;
volatile bit M0K3IO               @ ((unsigned)&TKM0C1*8)+2;
volatile bit M0K4IO               @ ((unsigned)&TKM0C1*8)+3;
volatile bit M0KOEN               @ ((unsigned)&TKM0C1*8)+4;
volatile bit M0TSS                @ ((unsigned)&TKM0C1*8)+7;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	M0K1IO              : 1;
...
// Register: TKM1C0
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           TKM1C0               @ 0x398;
// bit and bitfield definitions
volatile bit M1SOF0               @ ((unsigned)&TKM1C0*8)+0;
volatile bit M1SOF1               @ ((unsigned)&TKM1C0*8)+1;
volatile bit M1SOFC               @ ((unsigned)&TKM1C0*8)+3;
volatile bit M1FILE               @ ((unsigned)&TKM1C0*8)+4;
volatile bit M1DFEN               @ ((unsigned)&TKM1C0*8)+5;
volatile bit M1MXS0               @ ((unsigned)&TKM1C0*8)+6;
volatile bit M1MXS1               @ ((unsigned)&TKM1C0*8)+7;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	M1SOF0              : 1;
...
// Register: TKM1C1
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           TKM1C1               @ 0x399;
// bit and bitfield definitions
volatile bit M1K1IO               @ ((unsigned)&TKM1C1*8)+0;
volatile bit M1K2IO               @ ((unsigned)&TKM1C1*8)+1;
volatile bit M1K3IO               @ ((unsigned)&TKM1C1*8)+2;
volatile bit M1K4IO               @ ((unsigned)&TKM1C1*8)+3;
volatile bit M1KOEN               @ ((unsigned)&TKM1C1*8)+4;
volatile bit M1TSS                @ ((unsigned)&TKM0C1*8)+7;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	M1K1IO              : 1;
...
// Register: TKM2C0
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           TKM2C0               @ 0x39A;
// bit and bitfield definitions
volatile bit M2SOF0               @ ((unsigned)&TKM2C0*8)+0;
volatile bit M2SOF1               @ ((unsigned)&TKM2C0*8)+1;
volatile bit M2SOFC               @ ((unsigned)&TKM2C0*8)+3;
volatile bit M2FILE               @ ((unsigned)&TKM2C0*8)+4;
volatile bit M2DFEN               @ ((unsigned)&TKM2C0*8)+5;
volatile bit M2MXS0               @ ((unsigned)&TKM2C0*8)+6;
volatile bit M2MXS1               @ ((unsigned)&TKM2C0*8)+7;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	M2SOF0              : 1;
...
// Register: TKM2C1
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           TKM2C1               @ 0x39B;
// bit and bitfield definitions
volatile bit M2K1IO               @ ((unsigned)&TKM2C1*8)+0;
volatile bit M2K2IO               @ ((unsigned)&TKM2C1*8)+1;
volatile bit M2K3IO               @ ((unsigned)&TKM2C1*8)+2;
volatile bit M2K4IO               @ ((unsigned)&TKM2C1*8)+3;
volatile bit M2KOEN               @ ((unsigned)&TKM2C1*8)+4;
volatile bit M2TSS                @ ((unsigned)&TKM0C1*8)+7;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	M2K1IO              : 1;
...
// Register: TKM3C0
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           TKM3C0               @ 0x39C;
// bit and bitfield definitions
volatile bit M3SOF0               @ ((unsigned)&TKM3C0*8)+0;
volatile bit M3SOF1               @ ((unsigned)&TKM3C0*8)+1;
volatile bit M3SOFC               @ ((unsigned)&TKM3C0*8)+3;
volatile bit M3FILE               @ ((unsigned)&TKM3C0*8)+4;
volatile bit M3DFEN               @ ((unsigned)&TKM3C0*8)+5;
volatile bit M3MXS0               @ ((unsigned)&TKM3C0*8)+6;
volatile bit M3MXS1               @ ((unsigned)&TKM3C0*8)+7;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	M3SOF0              : 1;
...
// Register: TKM3C1
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           TKM3C1               @ 0x39D;
// bit and bitfield definitions
volatile bit M3K1IO               @ ((unsigned)&TKM3C1*8)+0;
volatile bit M3K2IO               @ ((unsigned)&TKM3C1*8)+1;
volatile bit M3K3IO               @ ((unsigned)&TKM3C1*8)+2;
volatile bit M3K4IO               @ ((unsigned)&TKM3C1*8)+3;
volatile bit M3KOEN               @ ((unsigned)&TKM3C1*8)+4;
volatile bit M3TSS                @ ((unsigned)&TKM3C1*8)+7;
#ifndef _LIB_BUILD
volatile union {
    struct {
        unsigned	M3K1IO              : 1;
...
volatile bit URSTOP                    @ ((unsigned)&I2CCMD*8)+1;
...
volatile bit STOP                   @ ((unsigned)&URLCR*8)+2;
...
// Register: CF0OUT1L
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF0OUT1L              @ 0xF8E;
// bit and bitfield definitions

// Register: CF0OUT1H
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF0OUT1H              @ 0xF8F;
// bit and bitfield definitions

// Register: CF0OUT2L
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF0OUT2L              @ 0xF90;
// bit and bitfield definitions

// Register: CF0OUT2H
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF0OUT2H              @ 0xF91;
// bit and bitfield definitions

// Register: CF0OUT3L
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF0OUT3L              @ 0xF92;
// bit and bitfield definitions

// Register: CF0OUT3H
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF0OUT3H              @ 0xF93;
// bit and bitfield definitions

// Register: TKM016DL
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           TKM016DL              @ 0xF94;
// bit and bitfield definitions

// Register: TKM016DH
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           TKM016DH              @ 0xF95;
// bit and bitfield definitions

// Register: CF1OUT1L
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF1OUT1L              @ 0xF96;
// bit and bitfield definitions

// Register: CF1OUT1H
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF1OUT1H              @ 0xF97;
// bit and bitfield definitions

// Register: CF1OUT2L
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF1OUT2L              @ 0xF98;
// bit and bitfield definitions

// Register: CF1OUT2H
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF1OUT2H              @ 0xF99;
// bit and bitfield definitions

// Register: CF1OUT3L
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF1OUT3L              @ 0xF9A;
// bit and bitfield definitions

// Register: CF1OUT3H
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF1OUT3H              @ 0xF9B;
// bit and bitfield definitions

// Register: TKM116DL
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           TKM116DL              @ 0xF9C;
// bit and bitfield definitions

// Register: TKM116DH
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           TKM116DH              @ 0xF9D;
// bit and bitfield definitions

// Register: CF2OUT1L
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF2OUT1L              @ 0xF9E;
// bit and bitfield definitions

// Register: CF2OUT1H
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF2OUT1H              @ 0xF9F;
// bit and bitfield definitions

// Register: CF2OUT2L
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF2OUT2L              @ 0xFA0;
// bit and bitfield definitions

// Register: CF2OUT2H
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF2OUT2H              @ 0xFA1;
// bit and bitfield definitions

// Register: CF2OUT3L
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF2OUT3L              @ 0xFA2;
// bit and bitfield definitions

// Register: CF2OUT3H
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF2OUT3H              @ 0xFA3;
// bit and bitfield definitions

// Register: TKM216DL
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           TKM216DL              @ 0xFA4;
// bit and bitfield definitions

// Register: TKM216DH
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           TKM216DH              @ 0xFA5;
// bit and bitfield definitions

// Register: CF3OUT1L
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF3OUT1L              @ 0xFA6;
// bit and bitfield definitions

// Register: CF3OUT1H
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF3OUT1H              @ 0xFA7;
// bit and bitfield definitions

// Register: CF3OUT2L
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF3OUT2L              @ 0xFA8;
// bit and bitfield definitions

// Register: CF3OUT2H
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF3OUT2H              @ 0xFA9;
// bit and bitfield definitions

// Register: CF3OUT3L
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF3OUT3L              @ 0xFAA;
// bit and bitfield definitions

// Register: CF3OUT3H
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           CF3OUT3H              @ 0xFAB;
// bit and bitfield definitions

// Register: TKM316DL
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           TKM316DL              @ 0xFAC;
// bit and bitfield definitions

// Register: TKM316DH
// LVDIErrupt-On-Change Flag Register
volatile unsigned char           TKM316DH              @ 0xFAD;
// bit and bitfield definitions
