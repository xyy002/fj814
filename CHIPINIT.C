...
void Time1Initial(void)
{
    ...
    //BIT7:�Զ�Ԥװ������λ
		...
		//BIT6~BIT5:ѡ�����ģ�?
			//00�����ض���ģʽ�����������ݷ���λ(DIR)���ϻ����¼�����
			//01���������ģ�?1����������������Ϻ����¼����������?������?��(TIM1_CCMRx�Ĵ�����CciS=00)������Ƚ��жϱ�־λ��ֻ�ڼ��������¼���ʱ����?1�� 
			//10:�������ģ�?2����������������Ϻ����¼����������?������?��(TIM1_CCMRx�Ĵ�����CciS=00)������Ƚ��жϱ�־λ��ֻ�ڼ��������ϼ���ʱ����?1��
			//11���������ģ�?3����������������Ϻ����¼����������?������?��(TIM1_CCMRx�Ĵ�����CciS=00)������Ƚ��жϱ�־λ���ڼ��������Ϻ����¼���ʱ������?1��
		//BIT4:����
			//0�����������ϼ�����
			//1�����������¼�����
		//BIT3:������ģʽ
    ...
    //BIT7��ɲ���жϱ��?,һ��ɲ��������Ч����Ӳ���Ը�λ��1�����ɲ��������Ч�����λ����������0��
		...
		//BIT2������/�Ƚ�2�жϱ��?
			//�ο�CC1IF������
		//BIT1������/�Ƚ�1�жϱ��?  ����?��CC1����Ϊ���ģʽ����������ֵ��Ƚ�ֵƥ��ʱ��λ��Ӳ����1���������ĶԳ�ģʽ�³���(�ο�TIM1_CR1�Ĵ�����CMSλ)������������0��
			//0����ƥ�䷢����
			//1��TIMx_CNT��ֵ��TIMx_CCR1��ֵƥ�䡣
			//ע�������ĶԳ�ģʽ�£���������ֵΪ0ʱ�����ϼ�������������ֵΪARRʱ�����¼���������0���ϼ�����ARR-1������ARR���¼�����1������ˣ������е�SMSλֵ��������ֵ�����ñ�ǡ����ǣ����CCR1>ARR����CNT�ﵽARRֵʱ��CC1IF��1��
			//����?��CC1����Ϊ����ģʽ���������¼�����ʱ��λ��Ӳ����1������������0��ͨ����TIM1_CCR1L��0��
			//0�������벶�������?
			//1��������ֵ�ѱ�����(����)��TIM1_CCR1(��IC1�ϼ�⵽����ѡ�������?�ı���)��
		//BIT0�������жϱ��?,�����������¼�ʱ��λ��Ӳ����1������������0��
			//0���޸����¼�������
			//1�������¼��ȴ���Ӧ�����Ĵ���������ʱ��λ��Ӳ����1��
			//��TIM1_CR1�Ĵ�����UDIS=0�������������������ʱ��?
    ...
    //BIT7������ɲ���¼�,��λ��������1�����ڲ���һ��ɲ���¼�����Ӳ���Զ���0��
		...
		//BIT1����������/�Ƚ�1�¼�
			...
			//����CC1IF=1����������Ӧ���жϣ��������Ӧ���жϡ����?��CC1����Ϊ���룺
			//��ǰ�ļ�����ֵ��������TIM1_CCR1�Ĵ���������CC1IF=1����������Ӧ���жϣ��������Ӧ���жϡ���CC1IF�Ѿ�Ϊ1��������CC1OF=1��
		//BIT0�����������¼�
			//��λ��������1����Ӳ���Զ���0��
			//0���޶�����
			//1�����³�ʼ����������������һ�������¼���ע��Ԥ��Ƶ���ļ�����Ҳ����0(����Ԥ��Ƶϵ������)���������ĶԳ�ģʽ�»�DIR=0(���ϼ���)�����������?0����DIR=1(���¼���)��������?TIM1_ARR��ֵ��
    ...
    TIM1CCMR1 =0B00000000;//CC1ͨ��������Ϊ���?
		...
		//BIG6~BIT4������Ƚ�?1ģʽ,��3λ����������ο��ź�OC1REF�Ķ�������OC1REF������OC1��ֵ��OC1REF�Ǹߵ�ƽ��Ч����OC1����Ч��ƽȡ����CC1Pλ��
			...
			//001��ƥ��ʱ����ͨ��1������?��Ч��ƽ����������TIM1_CNT��ֵ�벶��/�ȽϼĴ���1(TIM1_CCR1)��ͬʱ��ǿ��OC1REFΪ�ߡ�
			//010��ƥ��ʱ����ͨ��1������?��Ч��ƽ����������TIM1_CNT��ֵ�벶��/�ȽϼĴ���1(TIM1_CCR1)��ͬʱ��ǿ��OC1REFΪ�͡�
			...
			//ע3�����л���������?���ϣ���Щλ��Ԥװ�صġ����TIM1_CR2�Ĵ�����CCPC=1��OCM λֻ����COM�¼�����ʱ���Ŵ�Ԥװ��λȡ��ֵ��
		//BIT3������Ƚ�?1Ԥװ��ʹ��
		...
		//BIT2������Ƚ�?1 ����ʹ��,��λ���ڼӿ�CC����Դ��������¼�����Ӧ��?
			//0�����ݼ�������CCR1��ֵ��CC1������������ʹ�������Ǵ򿪵ġ�����������������һ����Ч��ʱ������CC1�������С��ʱ�?5��ʱ�����ڡ�
    ...
    TIM1CCER1 =0B00000000; //�Ƚ�1�������ʹ�ܣ��͵�ƽ��Ч���Ƚ���?1���ʹ�ܣ��͵�ƽ���?
    //BIT7�����벶��/�Ƚ�2����������ԡ��ο�CC1NP��������
		...
		//BIT3�����벶��/�Ƚ�1�����������?
			...
			//ע2�������л���������?������λ��Ԥװ�صġ����CCPC=1��TIM1_CR2�Ĵ�������ֻ����
		...
		//BIT2�����벶��/�Ƚ�1�������ʹ��?
			...
			//OIS1��OIS1N��CC1Eλ��ֵ��
			//ע�������л���������?������λ��Ԥװ�صġ����CCPC=1(TIM1_CR2�Ĵ���)��ֻ����
    ...
    TIM1DTR =0B00000111;   //����������
    //BIT7~BIT0: ��������������,��Щλ�����˲��뻥������?�����������ʱ�䡣����DT��ʾ�����ʱ�䣬tCK_PSCΪTIM1��ʱ�����壺
